...
/* ------------------------------------------------------------------ *
 *  1) API: /api/metrics, /api/metrics/latest, /api/metrics/{key},
 *          /api/config, /api/config/metrics, /api/config/metrics/{key}
 * ------------------------------------------------------------------ */
if (preg_match('#^/api/(config/metrics/[^/]+|config/metrics|metrics/latest|metrics/[^/]+|metrics|config)$#', $norm)) {
