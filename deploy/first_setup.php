...
$config = "<?php\n"
    ...
    . "// The SQLite path is derived by api/metrics.php from its own __DIR__;\n"
    . "// title/subtitle and metric definitions live in the database, and Basic\n"
    . "// Auth is handled by the root .htaccess. Only the API_TOKEN lives here.\n"
    . "\n"
